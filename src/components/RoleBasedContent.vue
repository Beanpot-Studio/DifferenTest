  ...
  <div>
    ...
    <div v-else-if="!isLoggedIn" class="p-6 bg-gray-100 rounded-lg">
      <div class="text-center">
        ...
        <h3 class="mt-2 text-xl font-medium text-gray-900">Sorry, you don't have access</h3>
        <p class="mt-1 text-gray-500">Please login</p>
        <div class="mt-4">
          <button 
            @click="$emit('login')" 
...
export default {
  ...
  computed: {
    ...
    isLoggedIn() {
      //if you have a user role, you can see content
